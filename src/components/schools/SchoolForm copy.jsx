...
const SchoolForm = ({ handleLoading, dataCities, dataColonies, textBtnSubmit }) => {
   ...
   const { createSchool, openDialog, setOpenDialog, toggleDrawer, school, formData } = useSchoolContext();
   ...
   const handleChange = (e) => {
      ...
      console.log(values.name, values.description, values.state);
   };
   ...
   useEffect(() => {
      // console.log("SchoolForm->useEffect->formData", formData);
      vformData.id = formData.id;
      vformData.code = formData.code;
      vformData.school = formData.school;
      vformData.city_id = formData.city_id;
      vformData.colony_id = formData.colony_id;
      vformData.address = formData.address;
      vformData.tel = formData.tel;
      vformData.director = formData.director;
      vformData.loc_for = formData.loc_for;
      vformData.zone = formData.zone;
      // setvFormData(formData);
      // vformData.code = "pruseba";
      console.log("formDataSAMUEL", formData);
      console.log("vformDataSAMUEELLLL", vformData);
   }, [formData]);

   // formData.code = "pruseba";
